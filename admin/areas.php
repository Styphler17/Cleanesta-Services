...
<div class="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
    <h1 class="text-2xl font-bold text-primary">Service Areas</h1>
    <button onclick="document.getElementById('addModal').classList.remove('hidden')" class="px-4 py-2 bg-primary text-white rounded hover:bg-secondary transition w-full sm:w-auto">+ Add Area</button>
</div>
<!-- Desktop Table -->
...
<div class="sm:hidden space-y-4">
    ...
    <div class="bg-white rounded-lg shadow p-4 flex flex-col gap-2">
        <div class="flex justify-between items-center">
            <span class="font-bold text-primary"><?php echo $area['area_name']; ?></span>
...
<div id="addModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-lg relative">
        ...
        <h2 class="text-xl font-bold mb-4 text-primary">Add Area</h2>
        <form method="post">
            <div class="mb-4">
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" name="add_area" class="px-4 py-2 bg-primary text-white rounded hover:bg-secondary transition">Add</button>
            </div>
        </form>
    </div>
</div>
...
<div id="editModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-lg relative">
        ...
        <h2 class="text-xl font-bold mb-4 text-primary">Edit Area</h2>
        <form method="post" id="editForm">
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" name="edit_area" class="px-4 py-2 bg-primary text-white rounded hover:bg-secondary transition">Update</button>
            </div>
        </form>
    </div>
</div>
