    ...
    <section id="process" class="py-12">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12 text-primary">How It Works</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                <!-- Step 1: Book -->
                <div class="group text-center transition-transform duration-300 hover:-translate-y-2">
                    <div class="w-14 h-14 bg-[var(--color-primary)] text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                        1
                    </div>
                    <div class="relative group">
                        ...
                        <div class="relative z-10 p-8 h-full">
                            <i class="fas fa-calendar-check text-[var(--color-secondary)] text-4xl mb-4 group-hover:scale-110 transition-transform duration-300"></i>
                            <h3 class="text-lg font-semibold mb-3 text-primary">Book</h3>
                ...
                <div class="group text-center transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <div class="relative group">
                        <div class="absolute inset-0 z-0 bg-gradient-to-br from-[var(--color-neutral)]/60 to-[var(--color-neutral)]/20 rounded-2xl border border-[var(--color-primary)]/30 group-hover:border-[var(--color-accent)]/60 backdrop-blur-lg transition-all duration-300 shadow-xl group-hover:shadow-2xl"></div>
                        <div class="relative z-10 p-8 h-full">
                            <i class="fas fa-clipboard-list text-[var(--color-secondary)] text-4xl mb-4 group-hover:scale-110 transition-transform duration-300"></i>
                            <h3 class="text-lg font-semibold mb-3 text-primary">Prepare</h3>
                ...
                <div class="group text-center transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <div class="relative group">
                        <div class="absolute inset-0 z-0 bg-gradient-to-br from-[var(--color-neutral)]/60 to-[var(--color-neutral)]/20 rounded-2xl border border-[var(--color-primary)]/30 group-hover:border-[var(--color-accent)]/60 backdrop-blur-lg transition-all duration-300 shadow-xl group-hover:shadow-2xl"></div>
                        <div class="relative z-10 p-8 h-full">
                            <i class="fas fa-broom text-[var(--color-secondary)] text-4xl mb-4 group-hover:scale-110 transition-transform duration-300"></i>
                            <h3 class="text-lg font-semibold mb-3 text-primary">Clean</h3>
                ...
                <div class="group text-center transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <div class="relative group">
                        <div class="absolute inset-0 z-0 bg-gradient-to-br from-[var(--color-neutral)]/60 to-[var(--color-neutral)]/20 rounded-2xl border border-[var(--color-primary)]/30 group-hover:border-[var(--color-accent)]/60 backdrop-blur-lg transition-all duration-300 shadow-xl group-hover:shadow-2xl"></div>
                        <div class="relative z-10 p-8 h-full">
                            <i class="fas fa-check-circle text-[var(--color-secondary)] text-4xl mb-4 group-hover:scale-110 transition-transform duration-300"></i>
                            <h3 class="text-lg font-semibold mb-3 text-primary">Review</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-24">
                <div class="relative group">
                    ...
                    <div class="relative z-10 p-8">
                        <h3 class="text-2xl font-semibold mb-6 text-primary">What to Expect</h3>
                        <ul class="space-y-4">
                            <li class="flex items-start">
                                <i class="fas fa-check text-[var(--color-secondary)] mt-1 mr-3"></i>
                ...
                <div class="relative group">
                    ...
                    <div class="relative z-10 p-8 flex flex-col justify-between">
                        <div>
                            <h3 class="text-2xl font-semibold mb-6 text-primary">Our Commitment</h3>
                        ...
                        <a href="./index.php?page=booking" class="inline-block px-8 py-3 text-white bg-[var(--color-secondary)] hover:bg-[var(--color-primary)] transition-colors duration-300 rounded-md shadow-md hover:shadow-xl text-lg font-semibold text-center mt-4">
